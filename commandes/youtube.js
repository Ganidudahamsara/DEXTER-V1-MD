...
_*Gagana-MD SONG DOWNLOADING......*_\n\n`
       }
...
_*Gagana-MD VIDEO DOWNLOADING......*_\n\n`
      };
      ...
      fileStream.on('finish', () => {
        ...
        zk.sendMessage(origineMessage, { video: { url :"./video.mp4"} , caption: "*Gagana-MD*", gifPlayback: false }, { quoted: ms });
      });
